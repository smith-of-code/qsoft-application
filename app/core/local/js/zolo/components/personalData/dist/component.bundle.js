    ...
    var PersonalData = {
      ...
      mounted: function mounted() {
        ...
        $('input[type=file][name=photo]').on('change', function () {
          _this2.mutableUserInfo.photo_id = $('input[type=file][name=photo]').parent().find('input[type=hidden]').val();
        });
      },
      methods: {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    _context.prev = 0;
                    _context.next = 3;
                    return _this3.personalDataStore.sendCode(value, type);
                  ...
                  case 9:
                    ...
                    _this3.phoneError = _context.t0.message ? _context.t0.message : true;
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    _context2.next = 4;
                    return _this4.personalDataStore.verifyCode(codeInput.val(), _this4.confirmationType);
                  ...
                  case 9:
                    if (_this4.confirmationType === 'phone') {
                      _this4.phoneError = false;
                      _this4.phoneVerified = _this4.mutableUserInfo.phone;
                    } else if (_this4.confirmationType === 'email') {
                      _this4.emailError = false;
                      _this4.emailVerified = _this4.mutableUserInfo.email;
                    }
                  ...
                  case 13:
                    ...
                    _this4.verifyError = true;
                    return _context2.abrupt("return");

                  case 17:
                    _this4.verifyError = false;
                    _this4.confirmationType = false;
                    $.fancybox.close({
                      src: '#approve-number'
                    });
