import dropzone from "../../../../../../../../../assets/js/modules/dropzone";
...
export const Dropzone = {
    ...
    mounted() {
        dropzone(document.getElementById(this.componentId));
    },

    template: `
        <div class="dropzone" data-uploader :id="componentId">
            <input type="file" :name="name" multiple class="dropzone__control">
        
            <div class="dropzone__area" :data-uploader-area='"{\"paramName\": \"" + name + "\", \"url\":\"/_markup/gui.php\"}"'>
                ...
                <div class="dropzone__previews dz-previews" data-uploader-previews>
                    <div v-for="file in files" class="file dz-processing dz-image-preview dz-success dz-complete" data-uploader-preview="">
