...
class AddBonusesDataOrderProp extends Migration
{
    private const PROPERTY = 'BONUSES_DATA';
    ...
    protected function prepareFields()
    {
        return [
            ...
            'NAME' => 'Данные по бонусам', //  - название свойства (тип плательщика зависит от сайта, а сайт - от языка; название должно быть на соответствующем языке);
            'TYPE' => 'STRING', //  - тип свойства. Допустимые значения:
            ...
            'CODE' => 'BONUSES_DATA', //  - символьный код свойства.
        ];
    }
