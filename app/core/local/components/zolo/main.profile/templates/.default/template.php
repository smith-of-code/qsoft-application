        ...
        <div class="private__col private__col--full">
            <div class="profile">
                ...
                <div class="accordeon">
                    ...
                    <div
                        id="pets"
                        prop-pets='<?=str_replace('\'', '"', CUtil::PhpToJSObject($arResult['pets']))?>'
                        prop-genders='<?=str_replace('\'', '"', CUtil::PhpToJSObject($arResult['pet_genders']))?>'
                        prop-breeds='<?=str_replace('\'', '"', CUtil::PhpToJSObject($arResult['pet_breeds']))?>'
                        prop-kinds='<?=str_replace('\'', '"', CUtil::PhpToJSObject($arResult['pet_kinds']))?>'
                    ></div>
                    <!--/Данные о питомцах-->
