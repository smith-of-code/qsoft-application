            ...
            <div class="profile__accordeon-header accordeon__header section__header">
                ...
                <div class="profitability__hint" data-tippy-html="">
                    ...
                    <div style="display: none;" data-tippy-template="">
                        <div >
                            <p >Вы можете поделиться своей персональной ссылкой на сайт или на регистрацию в качестве покупателя или консультанта. Все новые покупатели или консультанты, пришедшие по ссылке и прошедшие регистрацию, попадут в первый уровень Вашей структуры.</p>
