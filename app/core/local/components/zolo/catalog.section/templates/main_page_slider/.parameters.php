...
$arTemplateParameters['SLIDER_ID_FOOD'] = array(
    'PARENT' => 'DATA_SOURCE',
    'NAME' => 'ID слайдера для категории "Корма"',
    'TYPE' => 'STRING',
    'DEFAULT' => ''
);

$arTemplateParameters['SLIDER_ID_ACCESSORIES'] = array(
    'PARENT' => 'DATA_SOURCE',
    'NAME' => 'ID слайдера для категории "Аксессуары"',
    'TYPE' => 'STRING',
    'DEFAULT' => ''
);
