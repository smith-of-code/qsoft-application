            ...
            <div class="subject">
                <div class="subject__row">
                    <div class="subject__item box box--circle box--grayish">
                        ...
                        <div class="subject__info">
                            ...
                            <span type="button" class="subject__button button button--simple button--red">
                                            <span class="subject__button-icon button__icon button__icon--small button__icon--right">
                        ...
                        <div class="subject__image">
                            <img src="/local/templates/.default/images/dog2.png" alt="Каталог для собак"
                                 class="subject__image-pic">
                        </div>
                    </div>
                    ...
                    <div class="subject__item box box--circle box--grayish">
                        ...
                        <div class="subject__image">
                            <img src="/local/templates/.default/images/cat2.png" alt="Каталог для собак"
                                 class="subject__image-pic">
                        </div>
                    </div>
                </div>
        ...
        <section class="main__section main__section--separated">
            <div class="main__section-header">
                ...
                <a href="#" type="button" class="button button--simple button--red button--transition">
                                <span class="button__icon button__icon--small button__icon--red button__icon--right">
                                    <svg class="icon icon--arrow-right-light">
                                        <use xlink:href="/local/templates/.default/images/icons/sprite.svg#icon-arrow-right-light"></use>
                                    </svg>
                                </span>
                ...
                <div class="main__tabs-body tabs__body">
                    ...
                    <div class="tabs__block tabs__block--active" data-tab-section="food">
                        <div class="product-cards" data-show-cards>
                            <ul class="product-cards__list">
                                <li class="product-cards__item">
                                    <article class="product-card box box--circle box--hovering box--grayish">
                                        ...
                                        <div class="product-card__header">
                                            <div class="product-card__label label label--violet">ограниченное
                                                предложение
                                            </div>

                                            <div class="product-card__favourite">
                                                <button type="button"
                                                        class="product-card__favourite-button button button--ordinary button--iconed button--simple button--big button--red"
                                                        data-card-favourite="heart">
                                                                <span class="button__icon button__icon--big">
                                                                    <svg class="icon">
                                                                        <use xlink:href="/local/templates/.default/images/icons/sprite.svg#icon-heart"
                                                                             data-card-favourite-icon></use>
                                                                    </svg>
                                                                </span>
                                                </button>
                                            </div>
                                            ...
                                            <div class="product-card__wrapper">
                                                <div class="product-card__image box box--circle">
                                                    <div class="product-card__box">
                                                        <img src="/local/templates/.default/images/portage.png"
                                                             alt="Название товара" class="product-card__pic">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="product-card__content">
                                            <h6 class="product-card__title">Клиппер-переноска для кошек и собак Ferplast
                                                Jet 10 серый/фиолетовый серый/фиолетовыйсерый/фиолетовый
                                                серый/фиолетовый</h6>
                                            ...
                                            <div class="product-card__colors colors">
                                                <ul class="colors__list">
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r1" id="radio" checked>
                                                                <label for="radio">
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r2" id="radio2">
                                                                <label for="radio2">
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio3">
                                                                <label for="radio3">
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r4" id="radio4">
                                                                <label for="radio4">
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio5">
                                                                <label for="radio5">
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio6">
                                                                <label for="radio6">
                                            ...
                                            <div class="product-card__breed">
                                                <div class="select select--mini" data-select>
                                                    <select class="select__control" name="select1m" data-select-control
                                            ...
                                            <div class="product-card__cart">
                                                <div class="quantity" data-quantity>
                                                    <div class="quantity__button" data-quantity-button>
                                                        <button type="button"
                                                                class="button button--full button--medium button--rounded button--covered button--white-green">
                                                    ...
                                                    <div class="quantity__actions">
                                                        <div class="quantity__decrease">
                                                            <button type="button"
                                                                    class="button button--iconed button--covered button--square button--small button--gray-red"
                                                        ...
                                                        <div class="quantity__total">
                                                            ...
                                                            <span class="quantity__total-sum"
                                                                  data-quantity-sum="0">0</span>
                                                        </div>

                                                        <div class="quantity__increase">
                                                            <button type="button"
                                                                    class="button button--iconed button--covered button--square button--small button--gray-green"
                                ...
                                <li class="product-cards__item">
                                    <article class="product-card box box--circle box--hovering box--grayish">
                                        <a href="#" class="product-card__link"></a>
                                        <div class="product-card__header">
                                            <div class="product-card__label label label--pink">сезонное предложение
                                            </div>
                                        ...
                                        <div class="product-card__content">
                                            ...
                                            <div class="product-card__packs product-card__packs--desktop packs">
                                                <ul class="packs__list">
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r11" id="radio11p"
                                                                       checked>
                                                                <label for="radio11p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r22" id="radio22p">
                                                                <label for="radio22p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r33" id="radio33p">
                                                                <label for="radio33p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r44" id="radio44p">
                                                                <label for="radio44p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r55" id="radio55p">
                                                                <label for="radio55p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r66" id="radio66p">
                                                                <label for="radio66p">
                                                    ...
                                                    <li class="packs__item">
                                                        <div class="pack">
                                                            <div class="radio">
                                                                <input type="radio" class="pack__input radio__input"
                                                                       name="radio11p" value="r77" id="radio77p">
                                                                <label for="radio77p">
                                            ...
                                            <div class="product-card__packs product-card__packs--mobile">
                                                <div class="select select--mini" data-select>
                                                    <select class="select__control" name="select1p" data-select-control
                                                            data-placeholder="Выберите фасовку" data-option>
                                                        <option><!-- пустой option для placeholder --></option>
                                ...
                                <li class="product-cards__item">
                                    <article class="product-card box box--circle box--hovering box--grayish">
                                        ...
                                        <div class="product-card__content">
                                                ...
                                                <ul class="colors__list">
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r1" id="radioc" checked>
                                                                <label for="radioc">
                                                                    <div class="color__item color__item--pink"></div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r2" id="radio2c">
                                                                <label for="radio2c">
                                                                    <div class="color__item color__item--blue"></div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio3c">
                                                                <label for="radio3c">
                                                                    <div class="color__item color__item--green"></div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r4" id="radio4c">
                                                                <label for="radio4c">
                                                                    <div class="color__item color__item--yellow"></div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio5c">
                                                                <label for="radio5c">
                                                                    <div class="color__item color__item--red"></div>
                                                                </label>
                                                            </div>
                                                    ...
                                                    <li class="colors__item">
                                                        <div class="color">
                                                            <div class="radio">
                                                                <input type="radio" class="color__input radio__input"
                                                                       name="radio2" value="r3" id="radio6c">
                                                                <label for="radio6c">
                                                                    <div class="color__item color__item--violet"></div>
                                                                </label>
                                                            </div>
                                            ...
                                            <div class="product-card__breed">
                                                <div class="select select--mini" data-select>
                                                    <select class="select__control" name="select11m" data-select-control
                                                            data-placeholder="Выберите размер" data-option>
                                                        <option><!-- пустой option для placeholder --></option>
                                                        <option value="1">Для всех пород</option>
                                                        <option value="2">Мелкие породы</option>
                                ...
                                <li class="product-cards__item">
                                    <article
                                            class="product-card product-card--marketing box box--circle box--hovering box--grayish">
                                        <a href="#" class="product-card__link"></a>
                                        <div class="product-card__header">
                                            <div class="product-card__wrapper">
                                                <div class="product-card__image box box--circle">
                                                    <div class="product-card__box">
                                                        <img src="/local/templates/.default/images/animals2.png"
                                                             alt="Название товара" class="product-card__pic">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="product-card__content">
                                            ...
                                            <p class="product-card__text">Побалуйте вашего питомца - телятина, цыпленок,
                                                индейка, кролик - он захочет попробовать все!</p>
                                        </div>
                                ...
                                <li class="product-cards__item product-cards__item--hidden" data-show-card>
                                    <article class="product-card box box--circle box--hovering box--grayish">
                                        ...
                                        <div class="product-card__content">
                                            ...
                                            <div class="product-card__breed">
                                                <div class="select select--mini" data-select>
                                                    <select class="select__control" name="select1m" id="select1m"
                                                            data-select-control data-placeholder="Выберите размер"
                                                            data-option>
                                                        <option><!-- пустой option для placeholder --></option>
                                                        <option value="1">Для всех пород</option>
                                                        <option value="2">Мелкие породы</option>
                                ...
                                <li class="product-cards__item product-cards__item--hidden" data-show-card>
                                    <article class="product-card box box--circle box--hovering box--grayish">
                                        ...
                                        <div class="product-card__content">
                                            ...
                                            <div class="product-card__packs product-card__packs--mobile">
                                                <div class="select select--mini" data-select>
                                                    <select class="select__control" name="select1p" id="select1p"
                                                            data-select-control data-placeholder="Выберите фасовку"
                                                            data-option>
                                                        <option><!-- пустой option для placeholder --></option>
                                                        <option value="1">600 г</option>
                                                        <option value="2">1 кг</option>
                            ...
                            <button type="button"
                                    class="product-cards__button button button--full button--rounded button--covered button--white-green"
                                    data-show-button>
                                Показать еще
                            </button>
                        </div>
            ...
            <div class="cards-compilation">
                <ul class="cards-compilation__list">
                    <li class="cards-compilation__item cards-compilation__item--business cards-compilation__item--extra">
                        ...
                        <article
                                class="card-compilation card-compilation--big card-compilation--green box box--hovering box--circle">
                    ...
                    <li class="cards-compilation__item cards-compilation__item--sale cards-compilation__item--extra">
                        ...
                        <article
                                class="card-compilation card-compilation--medium card-compilation--grey box box--hovering box--circle">
                            <a href="#" class="card-compilation__link"></a>
                    ...
                    <li class="cards-compilation__item cards-compilation__item--compilation">
                        ...
                        <article
                                class="card-compilation card-compilation--small card-compilation--violet box box--hovering box--circle">
                            <a href="#" class="card-compilation__link"></a>
                ...
                <div class="company__row">
                    <div class="company__col">
                        ...
                        <div class="company__content">
                            <p class="company__text">Мы выбираем только качественную продукцию, которую не стыдно
                                порекомендовать маме, лучшему другу или коллегам в офисе.</p>
                            <p class="company__text">Наша цель - объединить людей, которые любят животных и стремятся
                                дать лучшее нашим меньшим братьям, ведь они нам доверяют.</p>
                            <p class="company__text">Поэтому мы предлагаем широкий ассортимент сухих и влажных кормов
                                <span class="company__text-accent">Premium и Super Premium</span> класса, а также
                                современные и качественные аксессуары по привлекательной цене. </p>
                        </div>
                    </div>
