                    ...
                    <div class="breadcrumbs">
                        <ul class="breadcrumbs__list">
                            ...
                            <li class="breadcrumbs__item breadcrumbs__item--active">
                                <a class="breadcrumbs__link">Товары для собак</a>
                            </li>
                        </ul>
                    </div>

                    <h1 class="page__heading">Товары для собак</h1>
                                    ...
                                    <div class="filter__wrapper" data-filter-block>
                                        <div class="filter__block" data-scrollbar>
                                            <div class="filter__head">
                                                ...
                                                <h2 class="filter__heading">Товары для собак</h2>
                                            </div>
                                            <form class="form">
                                                            ...
                                                            <li class="category__item">
                                                                <div class="accordeon accordeon--small" data-accordeon>
                                                                    <div class="accordeon__header" data-accordeon-toggle>
                                                                        <a href="#" class="accordeon__title category__item-link button button--simple button--red">Аксессуары</a>
                                                                    ...
                                                                    <div class="filter__accordeon-body accordeon__body" data-accordeon-content>
                                                                        <div class="category">
                                                                            <ul class="category__list">
                                                                                <li class="category__item">
                                                                                    <a href="#" class="category__item-link button button--simple button--red">Игрушки</a>
                                                                                </li>
                                                                                <li class="category__item">
                                                                                    <a href="#" class="category__item-link button button--simple button--red">Домики и лежанки</a>
                                                                                </li>
                                                                                <li class="category__item">
                                                                                    <a href="#" class="category__item-link button button--simple button--red">Для прогулок</a>
                                                                                </li>
                                                                                <li class="category__item">
                                                                                    <a href="#" class="category__item-link button button--simple button--red">Для кормления</a>
                                                                                </li>
                                                                                <li class="category__item">
                                                                                    <a href="#" class="category__item-link button button--simple button--red">Умные товары</a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
