                    ...
                    <div class="content__main">
                        <div class="detail__card">
                            <div class="detail__card-specification detail__card-specification--mobile specification">
                                <p class="specification__title">Умная игрушка для кошек Smart Dot, Petoneer</p>
                                <p class="specification__article">Арт. СХ-С-956027</p>
                            </div>
                            ...
                            <div class="detail__card-wrapper">
                                <div class="detail__card-specification specification">
                                    <p class="specification__title specification__title--hidden">Умная игрушка для кошек Smart Dot, Petoneer</p>
                                    <p class="specification__article specification__article--hidden">Арт. СХ-С-956027</p>
                                    ...
                                    <div class="specification__breed">
                                        ...
                                        <div class="specification__select select select--middle" data-select>
                                            <select class="select__control" name="select1m" data-select-control data-placeholder="Выберите размер" data-option>
                                                ...
                                                <option value="2">Для мелких пород</option>
                                                <option value="3">Для средних пород</option>
                                                <option value="4">Для крупных пород</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="specification__description">
                                        <li class="specification__description-item">
                                            ...
                                            <p class="specification__description-response">Все возрасты</p>
                                        </li>
    
                                        <li class="specification__description-item">
                                            <p class="specification__description-topic">Материал</p>
                                            <p class="specification__description-response">Пластик</p>
                                        </li>
                                    </ul>
                                </div>
