                ...
                <main class="page__faq faq">
                    ...
                    <div class="content__main">
                        <div class="faq__wrapper">
                            <ul class="faq__questions questions">
                                <li class="questions__item">
                                    <div class="question">
                                        <h3 class="question__theme">Регистрация</h3>
                                ...
                                <li class="questions__item">
                                    <div class="question">
                                        <h3 class="question__theme">Консультанты</h3>
                                ...
                                <li class="questions__item">
                                    <div class="question">
                                        <h3 class="question__theme">Оплата</h3>
                                ...
                                <li class="questions__item">
                                    <div class="question">
                                        <h3 class="question__theme">Доставка</h3>
                            ...
                            <div class="faq__setask setask">
                                ...
                                <button type="button" class="setask__button button button--rounded button--covered button--green">
                                    Задать вопрос
                                </button>
                            </div>
                        </div>
