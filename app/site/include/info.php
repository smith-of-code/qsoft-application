<div class="mb-5">
	...
	<div class="p-3 mb-2 bg-light text-dark rounded">
		...
		<div class="mb-3">
			...
			<div style="font-size: .8rem;">Узнайте больше о нашем магазине: кто мы, наши клиенты и почему они выбрали именно нас. Наши контакты и реквизиты. <br><a href="/info/ame-business/">Подробнее</a>
			</div>
		</div>
